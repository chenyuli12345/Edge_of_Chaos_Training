...
def main():
    ...
    fig.tight_layout()
    plt.savefig('.vscode/Edge_of_Chaos_Training-main/3.Model_evolution/results/coefficient/lr1', dpi=300)
    ...
    # plt.title(r'Coeeficient $A$ and momentum${\alpha}$', fontsize='22')
    fig.tight_layout()
    plt.savefig('.vscode/Edge_of_Chaos_Training-main/3.Model_evolution/results/coefficient/momentum1', dpi=300)
    ...
    # plt.title(r'Coeeficient $A$ and momentum${\alpha}$', fontsize='22')
    fig.tight_layout()
    plt.savefig('.vscode/Edge_of_Chaos_Training-main/3.Model_evolution/results/coefficient/batchsize', dpi=300)
